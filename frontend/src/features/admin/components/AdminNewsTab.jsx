                ...
                <tr key={item._id || item.id} className="hover:bg-fg/5 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-col gap-1 items-start">
                      ...
                      {item.tags?.length > 0 && (
                        <span className="text-[10px] text-muted max-w-[150px] truncate">
                          {item.tags.join(', ')}
                        </span>
                      )}
                    </div>
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer" 
                        className="cursor-pointer p-1.5 text-muted hover:text-fg rounded transition-colors"
                      ...
                      <button 
                        onClick={() => setNewsToDelete(item._id || item.id)} 
          ...
          <form onSubmit={handleEditSave} className="p-5 space-y-5">
            ...
            <div className="pt-4 flex justify-end gap-2 border-t border-border mt-6">
              ...
              <button 
                type="submit" 
                disabled={isSaving} 
                className="cursor-pointer disabled:cursor-not-allowed px-4 py-2 text-sm font-medium bg-fg text-bg rounded-xl hover:opacity-90 transition-opacity flex items-center gap-2"
              >
