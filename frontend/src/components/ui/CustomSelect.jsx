  ...
  return (
    <div className="relative inline-block w-full min-w-[160px]" ref={containerRef}>
      <button
        ...
        className="w-full flex items-center justify-between gap-3 px-4 py-2.5 bg-fg/5 border border-border rounded-xl text-sm font-medium text-fg hover:border-fg/20 focus:outline-none focus:border-industrial-accent transition-all text-left"
      >
          ...
          <div className="max-h-60 overflow-y-auto flex flex-col gap-1 scrollbar-hide">
            {options.map((opt) => (
              <button
                ...
                className={`w-full text-left px-3 py-2 text-sm font-medium transition-all rounded-xl flex items-center justify-between ${opt.value === value
